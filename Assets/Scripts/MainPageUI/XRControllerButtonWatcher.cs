...
public class XRControllerButtonWatcher : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            string tempStr = "not found inputFeature: " + ButtonInputFeature;
            Debug.LogError(tempStr);
            //   textInfo[0].text = tempStr;
        }
    }
    ...
    private void Update()
    {
        ...
        // textInfo[1].text ="dbNums:"+ devicesButton.Count+ " DState :" + tempState + " lastButtonState:" + lastButtonState;
