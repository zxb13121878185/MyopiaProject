...
Shader "IL3DN/Terrain First-Pass"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 weightedBlend9_g4 = ( weightedBlendVar9_g4.x*saturate( ( staticSwitch88_g4 + ( _Color0 * tex2D( _Splat0, uv_Splat0 ) ) ) ) + weightedBlendVar9_g4.y*saturate( ( staticSwitch88_g4 + ( _Color1 * tex2D( _Splat1, uv_Splat1 ) ) ) ) );
